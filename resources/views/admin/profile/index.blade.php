...
@section('content')
    <main id="main" class="main">
        ...
        <form method="POST" action="{{ route('profileUpdateAdmin', auth()->user()->id_user) }}">
            @csrf
            @method('PATCH')
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 my-3">
                        ...
                        <input name="email" type="email" value="{{ auth()->user()->email }}" class="form-control"
                            style="border: 2px solid #114B5F; border-radius:10px" placeholder="">
                    </div>
                    <div class="col-lg-6 my-3">
                        <h4 style="color: #114B5F">Password</h4>
                        <input name="password" type="password" class="form-control"
                            style="border: 2px solid #114B5F; border-radius:10px">
                    </div>

                    <div class="col-lg-6 my-3">
                        <h4 style="color: #114B5F">Phone Number</h4>
                        <input name="no_telp" type="text" value="{{ auth()->user()->no_telp }}" class="form-control"
                            style="border: 2px solid #114B5F; border-radius:10px">
                    </div>
                    <div class="col-lg-6 my-3">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <button type="submit" class="btn px-4 py-2 text-white"
                            style="background-color: #114B5F">Update</button>
                    </div>
                </div>
        </form>
        </div>
