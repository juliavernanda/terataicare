                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="d-flex justify-content-center py-2">
                            <div class="col-lg-6">
                                ...
                                <input type="text"  style="border: 2px solid #114B5F" class="form-control my-3 @error('nama_bidang') is-invalid @enderror" name="nama_bidang" placeholder="Input Nama Bidang">
                                @error('nama_bidang')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
